...
function displayCCode() {
  ...
  if (maze.id == levelForCode) {
    cCodeElem.innerHTML = '<span style="font-weight: bold;">You unlocked a coupon code!</span><p>Use code \'INSERTCODEHERE\' for X% off.';
    // display the modal
    openModal();
  }
}
...
var modal = document.getElementById("ccode-modal");

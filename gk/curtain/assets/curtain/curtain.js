...
lib.ssMetadata = [
		{name:"curtain_atlas_", frames: [[0,0,1600,818],[0,820,1600,818],[0,1640,1600,818]]}
];
...
(lib.Transition_B1 = function() {
	this.spriteSheet = ss["curtain_atlas_"];
	this.gotoAndStop(0);
...
(lib.Tween2 = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#FFFFFF").s().p("Ehg3AvJMAAAheRMDBvAAAMAAABeRg");
	this.shape.setTransform(0,-239.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.instance}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-620,-541.5,1240,1083);
...
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"images/curtain_atlas_.png", id:"curtain_atlas_"}
	],
	preloads: []
};

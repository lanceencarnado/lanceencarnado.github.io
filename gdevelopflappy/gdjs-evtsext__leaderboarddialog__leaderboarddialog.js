...
for (var i = 0, k = 0, l = gdjs.evtsExt__LeaderboardDialog__LeaderboardDialog.LeaderboardDialog.prototype.SetScoreContext.GDObjectObjects1.length;i<l;++i) {
    if ( gdjs.evtsExt__LeaderboardDialog__LeaderboardDialog.LeaderboardDialog.prototype.SetScoreContext.GDObjectObjects1[i].Score(eventsFunctionContext) >= eventsFunctionContext.localVariables[0].getFromIndex(0).getAsNumber() ) {
        isConditionTrue_0 = true;

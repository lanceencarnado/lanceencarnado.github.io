...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(11674644);
}
}
if (isConditionTrue_0) {
...
};gdjs.GameCode.asyncCallback11689516 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.GameCode.asyncCallback11689516(runtimeScene, asyncObjectsList)));
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(11687420);
}
}
}
if (isConditionTrue_0) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(11679148);
}
if (isConditionTrue_0) {
{gdjs.evtTools.runtimeScene.resetTimer(runtimeScene, "pipe_spawn");
}
...
{for(var i = 0, len = gdjs.GameCode.GDLeaderboardDialogObjects3.length ;i < len;++i) {
    gdjs.GameCode.GDLeaderboardDialogObjects3[i].SetScore(runtimeScene.getScene().getVariables().getFromIndex(1).getAsNumber(), null);
}
}
{for(var i = 0, len = gdjs.GameCode.GDLeaderboardDialogObjects3.length ;i < len;++i) {
    gdjs.GameCode.GDLeaderboardDialogObjects3[i].SetDefaultPlayerName(runtimeScene.getGame().getVariables().getFromIndex(0).getAsString(), null);
}
}
}
...
};gdjs.GameCode.asyncCallback11693308 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.GameCode.localVariables);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.1), (runtimeScene) => (gdjs.GameCode.asyncCallback11693308(runtimeScene, asyncObjectsList)));
}
}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(11692740);
}
if (isConditionTrue_0) {
...
for (var i = 0, k = 0, l = gdjs.GameCode.GDLeaderboardDialogObjects2.length;i<l;++i) {
    if ( gdjs.GameCode.GDLeaderboardDialogObjects2[i].IsRestartClicked(null) ) {
        isConditionTrue_0 = true;
...
for (var i = 0, k = 0, l = gdjs.GameCode.GDLeaderboardDialogObjects1.length;i<l;++i) {
    if ( gdjs.GameCode.GDLeaderboardDialogObjects1[i].IsScoreSubmitted(null) ) {
        isConditionTrue_0 = true;
...
{runtimeScene.getGame().getVariables().getFromIndex(0).setString((( gdjs.GameCode.GDLeaderboardDialogObjects1.length === 0 ) ? "" :gdjs.GameCode.GDLeaderboardDialogObjects1[0].PlayerName(null)));
}
{gdjs.evtTools.runtimeScene.replaceScene(runtimeScene, "Game", false);
}
}

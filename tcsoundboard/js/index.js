	...
	constructor(props) {
		...
		this.state = {
	  	sounds: [
			...
			{ id: 39, soundName: 'NARCISSISM OF SMALL DIFFERENCES (DROP)', soundURL: './sounds/narcissismdrop.mp3', isPlaying: false },
			{ id: 40, soundName: 'FORM IS EMPTINESS (DROP)', soundURL: './sounds/formisemptinessdrop.mp3', isPlaying: false },
            { id: 41, soundName: 'NOW I AM BECOME DEATH (DROP)', soundURL: './sounds/nowiambecomedeath.mp3', isPlaying: false, isNew: true },
            { id: 43, soundName: 'NEW YORK NEWS (DROP)', soundURL: './sounds/newyorknews.mp3', isPlaying: false, isNew: true },
            { id: 44, soundName: 'TIME CRISIS ENEMIES (DROP)', soundURL: './sounds/tcenemies.mp3', isPlaying: false, isNew: true },
            { id: 46, soundName: 'THIS IS YOUR SONG (DROP)', soundURL: './sounds/thisisyoursong.mp3', isPlaying: false, isNew: true },
            { id: 47, soundName: 'LOVE, I DON\'T GET ENOUGH OF IT (DROP)', soundURL: './sounds/loveidontgetenoughofit.mp3', isPlaying: false, isNew: true },
			...
			{ id: 32, soundName: 'NARCISSISM OF SMALL DIFFERENCE', soundURL: './sounds/narcissismofsmalldifference.mp3', isPlaying: false },
			{ id: 33, soundName: 'STRONG CHOICE', soundURL: './sounds/strongchoice.mp3', isPlaying: false },
			{ id: 34, soundName: 'IT\'S A DUMB TIME TO BE ALIVE', soundURL: './sounds/dumbtimetobealive.mp3', isPlaying: false },
			{ id: 35, soundName: 'THAT\'S A PORTMAN- TEAU', soundURL: './sounds/thatsaportmanteau.mp3', isPlaying: false },
			{ id: 36, soundName: '#THEBIG3 THAT MAKEMEME', soundURL: './sounds/thebig3thatmakememe.mp3', isPlaying: false },
			{ id: 37, soundName: 'WANGS', soundURL: './sounds/wangs.mp3', isPlaying: false },
			{ id: 38, soundName: 'NO FAP SUMMER', soundURL: './sounds/nofapsummer.mp3', isPlaying: false },
            { id: 42, soundName: 'KIND VIBE', soundURL: './sounds/kindvibe.mp3', isPlaying: false, isNew: true },
            { id: 45, soundName: 'BUT THIS WAS A FANTASY', soundURL: './sounds/thiswasafantasy.mp3', isPlaying: false, isNew: true },
            { id: 50, soundName: 'WHAT\'S WRONG WITH BEING FAT', soundURL: './sounds/whatswrongwithbeingfat.mp3', isPlaying: false, isNew: true },
            { id: 51, soundName: 'AS A MUSIC INDUSTRY PROFESS- IONAL', soundURL: './sounds/musicindustryprofessional.mp3', isPlaying: false, isNew: true },
            { id: 52, soundName: 'DOWN MEXICO WAY', soundURL: './sounds/downmexicoway.mp3', isPlaying: false, isNew: true },
            { id: 48, soundName: 'WHOA, HOLD UP GIRL...', soundURL: './sounds/whoaholdupgirl.mp3', isPlaying: false, isNew: true },
            { id: 49, soundName: 'AND IT\'S EASY TO SEE', soundURL: './sounds/anditseasytosee.mp3', isPlaying: false, isNew: true },
	  	]};
